...
GLuint BuildTriangles(GLfloat dx); // Constrói triângulos para renderização
GLuint BuildTriangles1(GLfloat dx); // Constrói triângulos para renderização
...
int main()
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(500, 500, "INF01047 - 290190 - Weslei Machado Bender", NULL, NULL);
    if (!window)
    {
        glfwTerminate();
    ...
    GLuint vertex_array_object_id = BuildTriangles(0);
 //   GLuint vertex_array_object_id2 = BuildTriangles1();
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        int *bits = get_bits(seconds, 4);

        if(bits[0]== 0){
                GLuint vertex_array_object_id = BuildTriangles(0.525);
                glBindVertexArray(vertex_array_object_id);
                ...
                GLuint vertex_array_object_id = BuildTriangles1(0.525);
                glBindVertexArray(vertex_array_object_id);
        ...
        if(bits[1]== 0){
                GLuint vertex_array_object_id = BuildTriangles(0.175);
                glBindVertexArray(vertex_array_object_id);
                glDrawElements(GL_TRIANGLE_STRIP, 34, GL_UNSIGNED_BYTE, 0);
                // "Desligamos" o VAO, evitando assim que operações posteriores venham a alterar o mesmo. Isso evita bugs.
                glBindVertexArray(0);
                ...
                GLuint vertex_array_object_id = BuildTriangles1(0.175);
                glBindVertexArray(vertex_array_object_id);
                glDrawElements(GL_TRIANGLE_STRIP, 7, GL_UNSIGNED_BYTE, 0);
                // "Desligamos" o VAO, evitando assim que operações posteriores venham a alterar o mesmo. Isso evita bugs.
                glBindVertexArray(0);
...
GLuint BuildTriangles(GLfloat dx)
{
...
GLfloat NDC_coefficients[] = {
    //    X      Y     Z     W
0.161679f, 0.133939f, 0.0f, 1.0f,
0.123744f, 0.247488f, 0.0f, 1.0f,
0.066969f, 0.323358f, 0.0f, 1.0f,
0.000000f, 0.350000f, 0.0f, 1.0f,
-0.066969f, 0.323358f, 0.0f, 1.0f,
-0.123744f, 0.247488f, 0.0f, 1.0f,
-0.161679f, 0.133939f, 0.0f, 1.0f,
-0.175000f, 0.000000f, 0.0f, 1.0f,
-0.161679f, -0.133939f, 0.0f, 1.0f,
-0.123744f, -0.247488f, 0.0f, 1.0f,
-0.066969f, -0.323358f, 0.0f, 1.0f,
-0.000000f, -0.350000f, 0.0f, 1.0f,
...
0.161679f, -0.133939f, 0.0f, 1.0f,
0.175000f, -0.000000f, 0.0f, 1.0f,
0.115485f, 0.095671f, 0.0f, 1.0f,
0.088388f, 0.176776f, 0.0f, 1.0f,
0.047835f, 0.230970f, 0.0f, 1.0f,
0.000000f, 0.250000f, 0.0f, 1.0f,
-0.047835f, 0.230970f, 0.0f, 1.0f,
-0.088388f, 0.176776f, 0.0f, 1.0f,
-0.115485f, 0.095671f, 0.0f, 1.0f,
-0.125000f, 0.000000f, 0.0f, 1.0f,
-0.115485f, -0.095671f, 0.0f, 1.0f,
-0.088388f, -0.176776f, 0.0f, 1.0f,
-0.047835f, -0.230970f, 0.0f, 1.0f,
-0.000000f, -0.250000f, 0.0f, 1.0f,
...
GLuint BuildTriangles1(GLfloat dx)
{
    // Primeiro, definimos os atributos de cada vértice.
...
GLfloat color_coefficients[] = {
    ...
    // Este vetor "indices" define a TOPOLOGIA (veja slide 114 do documento "Aula_04_Modelagem_Geometrica_3D.pdf").
    //
    GLubyte indices[] = { 0, 1, 2, 3, 0, 1, 4 }; // GLubyte: valores entre 0 e 255 (8 bits sem sinal).
